            ...
            <SimpleGrid columns={2} spacing={6}>
                <Stack spacing={"20px"}>
                    ...
                    <Box>
                        ...
                        ([key, value]) => {
                            const attributeValue = value as { trait: { type: string }, value: string };
                            return (
                                <Flex key={key} direction={"column"} alignItems={"center"} justifyContent={"center"} borderWidth={1} p={"8px"} borderRadius={"4px"}>
                                  <Text fontSize={"small"}>{attributeValue.trait.type}</Text>
                                  <Text fontSize={"small"} fontWeight={"bold"}>{attributeValue.value}</Text>
                                </Flex>
                              );
                        }
                        )}
